        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card card-success">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="<?= base_url('surat/add_sk_usaha') ?>" method="post">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="namausaha" placeholder="Nama usaha yang dimiliki" value="" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Berdiri Sejak</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="waktuusaha" placeholder="Misal: 1 Januari 2022 atau tahun 2000" value="" required>
                                </div>
                            </div>
                        </div>
