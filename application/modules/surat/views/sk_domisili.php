                ...
                <div class="card card-success">
                    ...
                    <form class="form-horizontal" action="<?= base_url('surat/add_sk_domisili') ?>" method="post">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Lama Berdomisili</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="waktumenetap" placeholder="Contoh: 10 tahun" value="" required>
                                </div>
                            </div>
                        </div>
